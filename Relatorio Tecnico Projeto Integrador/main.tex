...
% ---
\titulo{Projeto Integrador: Website alocação de imóveis}
\autor{ 
        Dark Sandra Soares Cares\\
        Gustavo Vieira Coelho\\
        Isa Torres Silva\\
        Jéssica Costa Santos\\
	  Patrick Ramalho de Sousa\\
        Rafael Almeida Barbosa\\
	Tiago Rodrigues Silva\\
	  Wellington Ribeiro Jardim\\
        }
\local{Araçuaí--MG}
\data{2024}
\instituicao{%
...
% ---
\include{capitulos/2-atividades}

% ---
% Conclusão
% ---
\include{capitulos/3-conclusao}
